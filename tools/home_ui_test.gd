...
func _ready() -> void:
	...
	_main._show_tab(1)
	_c("Harita'da sekme çubuğu görünür", tabs.visible and _main._screens[1].visible)
	_main._show_tab(2)
	...
	_c("OYNA → Harita sekmesi", _main._active_tab == 1 and tabs.active_tab() == 1 and tabs.visible)
	_main._show_tab(0)
